...
try:
    ...
    print(f"FATAL: Could not locate the main application logic within the package. Error: {e}", file=sys.stderr)
...
if __name__ == "__main__":
    ...
    try:
        ...
        logger.critical(f"An unexpected error occurred calling main_entry_point: {e}", exc_info=True)
